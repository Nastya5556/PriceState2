    ...
    public partial class begin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DpPriceOrganizations", x => new { x.Date, x.OrganizationId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_DpPriceOrganizations_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DpPriceOrganizations_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DpPriceOrganizations_OrganizationId",
                table: "DpPriceOrganizations",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_DpPriceOrganizations_ProductId",
                table: "DpPriceOrganizations",
                column: "ProductId");
